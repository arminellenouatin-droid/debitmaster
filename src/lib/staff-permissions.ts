...
export const defaultRolePermissions: Record<string, string[]> = {
  ...
  GERANT: ["orders.view", "orders.prepare", "orders.handoff", "stock.view", "stock.accept_counter", "team.view", "finance.view", "reports.view", "reports.daily_close", "messages.view", "messages.send"],
