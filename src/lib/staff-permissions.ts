...
export const defaultRolePermissions: Record<string, string[]> = {
  ...
  SUPERVISEUR: ["orders.view", "orders.create", "orders.prepare", "orders.deliver", "stock.view", "team.view", "reports.view", "messages.view", "messages.send", "tables.view", "tables.manage", "payments.create"],
  ...
  CHEF_CUISINE: ["orders.view", "orders.prepare", "team.view", "reports.view", "messages.view", "tables.view"],
