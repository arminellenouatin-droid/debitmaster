...
type MenuData = { company: { id: string; name: string; phone?: string | null; address?: string | null }; table: { id: string; label: string; zone: string | null }; products: Product[]; categories: Category[]; activities?: Activity[]; services?: Service[]; rooms?: Room[]; wifiTickets?: WifiTicket[] };
