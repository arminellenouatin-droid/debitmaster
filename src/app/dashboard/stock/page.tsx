...
export default async function StockPage() {
  ...
  if (context.role === "ADMINISTRATEUR" && context.employeeId === null && active.company?.activity_type === "POWER") return <DashboardShell firstName={firstName}><OwnerStockClient companyName={active.company?.name ?? "Établissement actif"} /></DashboardShell>;
