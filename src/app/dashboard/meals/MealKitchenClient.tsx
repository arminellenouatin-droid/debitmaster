...
type MealOrder = { id: string; order_number: string; table_label: string | null; server_name: string | null; status: string; created_at: string; order_items?: { id: string; product_name: string; quantity: number; fulfillment_unit: string | null; accompaniment?: string | null }[] };
type Cook = { id: string; first_name: string; last_name: string };
type Assignment = { id: string; order_id: string; order_item_id: string; cook_employee_id: string; quantity: number; status: string; order_items?: { product_name: string; fulfillment_unit: string | null; accompaniment?: string | null } | { product_name: string; fulfillment_unit: string | null; accompaniment?: string | null }[] | null; employees?: { first_name: string; last_name: string } | { first_name: string; last_name: string }[] | null };
