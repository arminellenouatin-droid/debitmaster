...
export default async function PowerPage() {
  ...
  if (!context.tenantId || (context.company?.activity_type !== "HOTEL_AUBERGE" && context.company?.activity_type !== "POWER") || !context.permissions.has("power.view")) redirect("/dashboard");
