...
export default async function PowerPage() {
  ...
  return <DashboardShell firstName={context.user.user_metadata?.first_name ?? context.company?.name ?? "équipe"}><PowerClient tenantId={context.tenantId} /></DashboardShell>;
}
