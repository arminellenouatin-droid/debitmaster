...
export function OrdersClient({ initialTableLabel = "" }: { initialTableLabel?: string }) {
  ...
  async function submitOrder() {
    ...
    try {
      ...
      setCart([]); setTableLabel(""); setMessage(`Commande ${result.order?.order_number ?? "enregistrée"}.`);
